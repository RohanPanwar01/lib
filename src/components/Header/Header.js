    ...
    <header className="dark:bg-gray-900 relative z-50">
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          {/* Desktop Navigation */}
          <nav className="hidden md:flex md:items-center md:gap-12" aria-label="Global">
      ...
      <div
        className={`fixed top-0 right-0 z-50 h-full w-3/4 max-w-xs bg-gray-900 dark:bg-gray-900 p-6 shadow-lg transform transition-transform duration-300 ${isMenuOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
      ...
      {/* <div className="mt-4 flex justify-center gap-6 md:hidden fixed bottom-6 left-0 right-0 px-6">
        <Link
          to="tel:+1234567890"
          className="flex items-center justify-center rounded-full bg-red-600 p-3 text-white shadow-sm dark:hover:bg-red-500"
          aria-label="Call"
        >
...
target="_blank"
rel="noopener noreferrer"
className="flex items-center justify-center rounded-full bg-green-600 p-3 text-white shadow-sm dark:hover:bg-green-500"
aria-label="WhatsApp"
>
<WhatsAppIcon />
</Link>
