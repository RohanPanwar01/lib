        ...
        <footer className="bg-white dark:bg-gray-900">
            <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        ...
                        <ul className="mt-8 flex gap-6">
                            ...
                            <li>
                                <a
                                    href="https://www.instagram.com/self_study_library_2023?igsh=a3l2ZnJpYTUyMTZx"
                                    rel="noreferrer"
                                    target="_blank"
                                    className="text-gray-700 transition hover:opacity-75 dark:text-gray-200"
                                >
                    ...
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
                        ...
                        <div>
                            <p className="font-medium text-gray-900 dark:text-white">Library</p>
                        ...
                        <div>
                            ...
                            <ul className="mt-6 space-y-4 text-sm">
                                <li>
                                    <Link to='/contactus' className="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
                                        Contact
                                    </Link>
                                </li>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                    &copy; 2025.Self Study Library . All rights reserved. | <a  style={{color:'blue'}} href='https://www.instagram.com/rohanpanwar_01?igsh=MWdxMGM1a2xhZ285MQ==' >Designed and Develop By Rohan Panwar</a>
                </p>
            </div>
        </footer>
    );
